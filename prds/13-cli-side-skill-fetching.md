...
**Status**: Implementation complete — **all milestones M0–M7 done, reviewed, and security-audited; full integration suite green.** Awaiting end-to-end sign-off + the joint release with the companion `vfarcic/dot-ai` PR #655 (both halves ship together). Milestone history below.
